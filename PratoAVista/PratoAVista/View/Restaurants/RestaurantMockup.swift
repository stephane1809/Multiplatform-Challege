...
class RestaurantMockup {
    ...
    static func getRestaurants() -> [RestaurantModel] {
        return [RestaurantModel(name: "Pasto & Pizza",
                                image: "pastoLogo",
                                location: "Av. Treze de Maio, 1017 - Fátima",
                                distance: 12,
                                tags: [RestaurantTag.freeWifi, RestaurantTag.petFrendly, RestaurantTag.withAirConditioning]),
