...
class JSONDish: Codable {
    ...
    init(recordName: String, category: String? = nil, dishName: String? = nil, ingredients: String? = nil, portion: String? = nil, price: Double? = nil, alergenics: [String] = []) {
        self.recordName = recordName
        self.category = category
        self.dishName = dishName
        self.ingredients = ingredients
